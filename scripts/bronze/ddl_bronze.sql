...
CREATE TABLE bronze.crm_product_info (
    ...
    prd_key      NVARCHAR(50),    -- Natural key (often used to join category data)
...
CREATE TABLE bronze.crm_sales_details (
    ...
    sls_order_dt INT,            -- Order Date (stored as INT/YYYYMMDD for raw layer)
    sls_ship_dt  INT,            -- Shipping Date (stored as INT/YYYYMMDD)
    sls_due_dt   INT,            -- Due Date (stored as INT/YYYYMMDD)
